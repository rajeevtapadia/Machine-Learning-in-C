/*
 * training a neruon with two two inputs, single output and no bias
 *
 * result: loss = 0.0833 after 40k iterations, 
 *         became very difficult to reduce loss futher,
 *         possible solution use sigmoid
 *
 * output:
 * intitial weights (randomly selected)
 * w1: 0.840188 w2: 0.394383
 * after training weights - 
 * w1: 0.667061 w2: 0.666929
 * x1 x2 y pred
 * 0  0  0 0.000000 
 * 1  0  1 0.667061 
 * 0  1  1 0.666929 
